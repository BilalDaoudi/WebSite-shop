        ...
        <div class="col-6 justify-content-center add_cat">
            <center>
                <form enctype="multipart/form-data" action="" method="POST">
                    ...
                    <input type="file" name="tphoto" class="inp" id="photo" accept=".jpg , .jpeg , .png"><br><br>
                    <input type="submit" name="btnModifier" id="btnModifier" class="btn" value="Modifier"><br><br>
                </form>
            </center>
        </div>
    </div>
